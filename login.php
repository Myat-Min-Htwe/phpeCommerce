...
if (isset($_POST['sub'])) {
    if ($_POST['user_email'] == "" || $_POST['user_password'] == "") {
        $err = "Fill your email and password first!";
    } else {
...
<body>
    ...
    <div class="h4 mb-2 fw-bold text-center text-danger"><?php echo $err; ?></div>
    
            <form method="POST" enctype="multipart/form-data" class="col-md-6 m-auto shadow p-5">
    
                <div class="mb-2 col-lg-12">
                    <label for="email" class="form-label fw-bold text-success">User Email</label>
                    <input type="email" class="form-control shadow bg-light" name="user_email">
    
                </div>
                <div class="mb-2 col-lg-12">
                    <label for="password" class="form-label fw-bold text-success">User Password</label>
                    <input type="password" class="form-control shadow bg-light" name="user_password">
                </div>
                ...
                <div class="mt-3">
                    <p class="fw-light text-light">Do you have a account? Please <a class="fw-bold text-success" href="register.php">Register here</a></p>
                </div>

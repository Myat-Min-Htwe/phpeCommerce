    ...
    <section class="container-fluid py-5 bg-dark">
        <div class="row text-center pt-3">
            <div class="col-lg-6 m-auto">
                <h1 class="text-success fw-bold">Welcome <span><?php echo "<font color='#6454CA'>" . $_REQUEST['name'] . "</font>"; ?></span></h1>
                <p class="fw-bold text-success">You have created your account successfully!!!</p>
                <p class="fw-bold text-success"><i>Let's Start Shopping Now !!!</i></p>

                <form action="reg_success.php" method="POST" enctype="multipart/form-data">
                <button class="btn btn-outline-success shadow px-5" type="submit" name="back">Back</button>
                </form>
            </div>
        </div>
    </section>

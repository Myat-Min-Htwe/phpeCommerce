...
<body>
    ...
    <section style="height: 550px;" class="container-fluid py-5 bg-dark">
        <div class="row text-center pt-3">
            <div class="col-lg-6 m-auto">
                <h1 class="text-success fw-bold">Welcome Admin</h1>
                <p class="fw-bold text-success"><i>Hope You Have A Great Day</i></p>
                <p class="fw-bold text-success"><i>Feel freely improve your page now</i></p>
                <div>
                    <img src="../img/luffy-gif.gif">
                </div>
